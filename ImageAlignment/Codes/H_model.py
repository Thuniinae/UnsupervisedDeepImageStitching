...
def build_model(inputs, is_training):
    with tf.variable_scope('model'):
        ...
        input2 = inputs[...,3:6]
        #resize to 128*128
        input1 = tf.image.resize_images(input1, [128,128],method=tf.image.ResizeMethod.BILINEAR)
        input2 = tf.image.resize_images(input2, [128,128],method=tf.image.ResizeMethod.BILINEAR)
