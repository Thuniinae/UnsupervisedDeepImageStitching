...
with tf.compat.v1.name_scope('training'):
    ...
    g_vars = tf.compat.v1.get_collection(key=tf.compat.v1.GraphKeys.TRAINABLE_VARIABLES, scope='Reconstruction')
...
tf.compat.v1.summary.scalar(tensor=hr_loss, name='hr_loss')
tf.compat.v1.summary.scalar(tensor=lr_loss, name='lr_loss')
tf.compat.v1.summary.scalar(tensor=consistency_loss, name='consistency_loss')

tf.compat.v1.summary.image(tensor=train_inputs[...,0:3], name='train_input1')
tf.compat.v1.summary.image(tensor=train_inputs[...,3:6], name='train_input2')
tf.compat.v1.summary.image(tensor=mask1, name='mask1')
tf.compat.v1.summary.image(tensor=mask2, name='mask2')
tf.compat.v1.summary.image(tensor=train_hr_stitched, name='train_hr_stitched')
tf.compat.v1.summary.image(tensor=train_lr_stitched, name='train_lr_stitched')
tf.compat.v1.summary.image(tensor=hr_seam_mask1, name='hr_seam_mask1')
tf.compat.v1.summary.image(tensor=hr_seam_mask2, name='hr_seam_mask2')
